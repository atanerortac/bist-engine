    ...
    for _, row in df_date.iterrows():
        ...
        if hacim >= MIN_HACIM['Kisa']:
            ...
            if puan >= thr['kisa_ruby']:
                ...
                _kisa_skip = piyasa == 'SARI' or (tier == 'Ruby' and breadth_oran < _ruby_min_breadth) or _wtf_ruby
                if not _kisa_skip:
                    p    = PARAMS['Kisa']
...
def backtest_calistir(cfg=None, months=None, days=None, out_suffix=''):
    ...
    if not baseline_df.empty:
        ...
        md = _kaydet_markdown(all_variant_results, run_time, tarih_aralik, all_dates=all_dates)
...
def _kaydet_markdown(all_variant_results, run_time, tarih_aralik, all_dates=None):
    ...
    lines = [
        ...
        "",
        "> Survivorship bias: aktif hisse evreni, devreden cikmis hisseler haric.",
        "> Gercek WR bu degerden ~%2-5 daha dusuk olabilir.",
        "",
        "---",
        "",
    ]
